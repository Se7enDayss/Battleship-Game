...
class PrintMessages:
    def welcome(self):
        print('\n'+ '='*30)
        print(Fore.RED + "Welcome to the Battleship Game" + Fore.RESET)
        print('='*30 + '\n')
    def ship_requirements(self):
        print("You need to place 5 ships on the board:")
        print("   - Carrier : 5 cells")
        print("   - Battleship : 4 cells")
        print("   - Destroyer : 3 cells")
        print("   - Submarine : 3 cells")
        print("   - Patrol Boat : 2 cells\n")
    def rules(self):
        print(Fore.RED+"Rules:"+Fore.RESET)
        print("""
